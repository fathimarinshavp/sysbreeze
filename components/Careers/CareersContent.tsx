        ...
        <main className="min-h-screen bg-[#050505] text-white pt-32 pb-20 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="flex flex-col items-center text-center mb-12 md:mb-16">
                    ...
                    >
                        Build Your Career <br /> with sysbreeze
                    </motion.h1>
                </div>
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="flex justify-center">
                                        <Link
                                            ...
                                            className="px-10 py-4 rounded-2xl border border-[#c1227d] text-[#c1227d] font-black text-lg uppercase tracking-tight transition-all hover:bg-[#c1227d] hover:text-black shadow-[0_0_30px_rgba(193,34,125,0.2)] hover:shadow-[0_0_50px_rgba(193,34,125,0.4)] text-center"
                                        >
                                            View Details
                                        </Link>
                                    </div>
