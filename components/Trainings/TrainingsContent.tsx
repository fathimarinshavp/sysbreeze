...
const trainingPrograms = [
    ...
    },
    {
        ...
        description:
            "Master Search Engine Optimization with our expert-led SEO training course. Learn keyword research, on-page SEO, off-page SEO, technical SEO, and analytics to rank websites on top of Google search results.",
        image: "/images/digitalmarketing.jpg",
        tags: ["SEO", "Ranking", "Online & Offline"],
        href: "/seo-training-course"
    },
    {
        title: "Python Full Stack Development Course",
        description:
            "Job-oriented Python Full Stack Development course covering Python programming, Django, APIs, and frontend technologies. Learn to build real-world web applications and become a professional full stack developer.",
    ...
    },
    {
        ...
        description:
            "Professional HR Management training course covering recruitment, employee onboarding, payroll management, and labor law compliance. This job-oriented certification program provides practical HR skills with placement assistance.",
        image: "/images/hr.jpg",
    ...
    {
        title: "FYUGP Internship in Kerala",
        description:
            "Industry-focused Four-Year Undergraduate Programme (FYUGP) internships across IT and Non-IT domains including Data Science, Digital Marketing, HR, Flutter, and Graphic Design with live projects and university credit eligibility.",
        image: "https://images.unsplash.com/photo-1523240795612-9a054b0db644?q=80&w=2070&auto=format&fit=crop",
        tags: ["FYUGP", "IT & Non-IT", "Credit-Eligible"],
        href: "/fyugp-internship-in-kerala"
    }
];
        ...
        <main className="min-h-screen bg-[#050505] text-white pt-32 pb-20 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="flex flex-col items-center text-center mb-12 md:mb-16">
                    ...
                    >
                        PROFESSIONAL IT TRAINING & <br /> INTERNSHIPS IN CALICUT
                    </motion.h1>
