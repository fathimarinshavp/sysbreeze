        ...
        <>
            <main className="min-h-screen bg-[#050505] text-white pt-32 relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    ...
                    {/* Content Section - Grid for Info Cards */}
                    <div className="grid lg:grid-cols-[1fr_1.2fr] gap-12 lg:gap-20 items-start max-w-7xl mx-auto mb-20">
                        {/* Left Column: Text */}
                            ...
                            >
                                ...
                                >
                                    <motion.button
                                        ...
                                        whileTap={{ scale: 0.95 }}
                                        className="bg-white/10 hover:bg-white/20 border border-white/10 px-10 py-4 rounded-3xl text-xl font-bold tracking-tight transition-colors"
                                    >
                                        Get Free Quote
                                    </motion.button>
                                </a>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                            {[
                                ...
                                },
                                {
                                    ...
                                    label: "Location",
                                    value: "Kinfra Techno Industrial Park, Kakkanchery, Calicut, Kerala",
                                    color: "text-[#c1227d]",
