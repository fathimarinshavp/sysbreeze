        ...
        >
            <div className="sticky top-0 h-screen w-full flex items-center justify-center">
                ...
                >
                    ...
                    <div
                        className="absolute inset-0 z-0 bg-[#0c0c0d] border border-white/10 rounded-[60px]"
                        style={{
                    ...
                    >
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="px-6 py-2 bg-white/10 hover:bg-white/20 border border-white/20 rounded-full text-white font-bold text-[10px] tracking-widest uppercase transition-colors backdrop-blur-sm flex items-center gap-2 mt-2 cursor-pointer"
                        >
                            Explore More
